  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="relative w-full max-w-sm rounded-3xl bg-white p-8 text-center shadow-2xl">
        ...
        <p className="mt-6 text-xl font-bold text-zinc-900">Booking Secured!</p>
        <p className="mt-2 text-sm leading-relaxed text-zinc-500">
          Your payment link would be sent to your email in less than 45 mins time after the
          moving company confirm your booking.
        </p>
      </div>
    </div>
  );
